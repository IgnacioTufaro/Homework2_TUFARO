...
class Course{
    private:
        vector<shared_ptr<Alumn>> alumns;
        int capacity;

    public:
        Course():capacity(20){}
        Course(vector<shared_ptr<Alumn>> new_alumns){alumns=new_alumns;capacity=20;}
        ...
        void set_alumn(){
            ...
            shared_ptr<Alumn> new_alumn = make_shared<Alumn>(fullname,docket,courses);
